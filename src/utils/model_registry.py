...
class ModelInfo:
    ...
    subfolder: Optional[str] = None # Optional remote HuggingFace subfolder
    revision: str = "main" # HuggingFace revision/commit used for downloads
    download_url: Optional[str] = None # Optional explicit download URL override
...
MODEL_REGISTRY = {
    ...
    "seedvr2_3b_int8_convrot.safetensors": ModelInfo(
        repo="Comfy-Org/SeedVR2", size="3B", precision="int8_convrot",
        subfolder="diffusion_models", revision="10f035adc869a5b3ffc466360b869641511c0610",
        sha256="c3dec8bcc5916843a8a858572970597462e1f2dc598d6dfd818f6cd40f53a157"
    ),
    "seedvr2_3b_nvfp4.safetensors": ModelInfo(
        repo="Comfy-Org/SeedVR2", size="3B", precision="nvfp4",
        subfolder="diffusion_models", revision="10f035adc869a5b3ffc466360b869641511c0610",
    ...
    # Comfy-Org native quantized models. Pinned to the verified snapshot that
    # introduced these files so the SHA256 entries remain stable.
    "seedvr2_7b_int8_convrot.safetensors": ModelInfo(
        repo="Comfy-Org/SeedVR2", size="7B", precision="int8_convrot",
        subfolder="diffusion_models", revision="10f035adc869a5b3ffc466360b869641511c0610",
        sha256="5aa0d25fc9d35e449b659d0c9a5dcb22e2a4fa04032101b95a39da42b32c1be6"
    ),
    "seedvr2_7b_nvfp4.safetensors": ModelInfo(
        repo="Comfy-Org/SeedVR2", size="7B", precision="nvfp4",
        subfolder="diffusion_models", revision="10f035adc869a5b3ffc466360b869641511c0610",
        sha256="cc4af1a7bd5377066496f393555478323e806fa21163bdbe3409451aface9b93"
    ),
    "seedvr2_7b_nvfp4_mixed_block35_fp16.safetensors": ModelInfo(
        repo="Comfy-Org/SeedVR2", size="7B", precision="nvfp4_mixed_block35_fp16",
        subfolder="diffusion_models", revision="10f035adc869a5b3ffc466360b869641511c0610",
        sha256="0ee5d7c4c4aac94fd24e3b68bb6e977aa4c7526e83499e183434cf6cced05fae"
    ),
    ...
    "seedvr2_7b_sharp_int8_convrot.safetensors": ModelInfo(
        repo="Comfy-Org/SeedVR2", size="7B", precision="int8_convrot", variant="sharp",
        subfolder="diffusion_models", revision="10f035adc869a5b3ffc466360b869641511c0610",
        sha256="db48be2f1cc7e36b01a2aa529810f5d9c6a971edd29be225cf1b0eb18d51c366"
    ),
    "seedvr2_7b_sharp_nvfp4.safetensors": ModelInfo(
        repo="Comfy-Org/SeedVR2", size="7B", precision="nvfp4", variant="sharp",
        subfolder="diffusion_models", revision="10f035adc869a5b3ffc466360b869641511c0610",
        sha256="80d57af7722f5a5bd4c01d2ab2688f2bf05e552e59d3d3287257de709db10397"
    ),
    "seedvr2_7b_sharp_nvfp4_mixed_block35_fp16.safetensors": ModelInfo(
        repo="Comfy-Org/SeedVR2", size="7B", precision="nvfp4_mixed_block35_fp16", variant="sharp",
        subfolder="diffusion_models", revision="10f035adc869a5b3ffc466360b869641511c0610",
        sha256="d5814e47c0b8cd968e0477e62a2e2663501c5fd1a2319f6dc8ba03efa35e0d56"
    ),
