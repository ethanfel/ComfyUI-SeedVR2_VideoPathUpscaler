...
"""
    ...
    perf_group.add_argument("--attention_mode", type=str, default="sdpa",
                        choices=["sdpa", "comfy_kitchen_int8", "flash_attn_2", "flash_attn_3", "sageattn_2", "sageattn_3"],
                        help="Attention backend: 'sdpa' (default), 'comfy_kitchen_int8', 'flash_attn_2', 'flash_attn_3', 'sageattn_2', or 'sageattn_3' (Blackwell GPUs)")
